...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Emeraldcoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x167f9370,0x3d7f9370,0x0138a8c0,0x0100a8c0,0x0101007f,0x0100007f
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Emeraldcoin is probably already running."), addrBind.ToString().c_str());
        else
